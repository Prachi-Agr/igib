  ...
  main.variable(observer("chart")).define("chart", ["d3","DOM","width","height","graph","x","margin","color","arc_x","step","viewof order","invalidation"], function(d3,DOM,width,height,graph,x,margin,color,arc_x,step,$0,invalidation)
{
  ...
  main.variable(observer("arc_x")).define("arc_x", ["margin"], function(margin){return(
function arc_x(d) {
  const x1 = d.source.x;
  const x2 = d.target.x;
  ...
  main.variable(observer("x")).define("x", ["d3","graph","margin","right"], function(d3,graph,margin,right){return(
...
600
  ...
  main.variable(observer("right")).define("right", ["data","step","margin"], function(data,step,margin){return(
